...
questions_list.append(Question('Кто является президентом Турции?', 'Реджеп Эрдаган', 'Джо Байден', 'Владимир Путин', 'Барак Обама'))
questions_list.append(Question('Чему равен прямой угол?', '90', '100', '30', '52'))
questions_list.append(Question('Кто был первым призидентом США?', 'Вашингтон', 'Обэмэ', 'Путин', 'Линкольн'))
