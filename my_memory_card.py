...
questions_list = [] 
questions_list.append(Question('В каком году отменили крепостное право?', '1861', '1488', '1864', '1812'))
questions_list.append(Question('Кто является президентом Турции?', 'Реджеп Эрдаган', 'Джо Байден', 'Владимир Путин', 'Аннонимус'))
questions_list.append(Question('Чему равен прямой угол?', '90', '100', '30', '52'))
questions_list.append(Question('Кто был первым призидентом США?', 'Вашингтон', 'Обэмэ', 'Путин', 'ПавелВсемогущи'))
questions_list.append(Question('Каков приблизительный курс евро на 04.11.2024?', '110', '100', '90', '52'))
...
def next_question():
    window.total += 1
    print('Статисика/n-Всего вопросов: ', window.total, '/n-Правильных ответов: ', window.score)
    cur_question = randint(0, len(questions_list) -1)
    q = questions_list[cur_question] # переходим к следующему вопросу
    ask(q) # спросили
